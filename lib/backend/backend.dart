...
import 'schema/fazendas_record.dart';
import 'schema/servicos_record.dart';
import 'schema/financeiro_record.dart';
import 'schema/conteudo_home_record.dart';
...
export 'schema/fazendas_record.dart';
export 'schema/servicos_record.dart';
export 'schema/financeiro_record.dart';
export 'schema/conteudo_home_record.dart';
...
/// Functions to query FazendasRecords (as a Stream and as a Future).
Future<int> queryFazendasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FazendasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FazendasRecord>> queryFazendasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FazendasRecord.collection,
      FazendasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FazendasRecord>> queryFazendasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ConteudoHomeRecords (as a Stream and as a Future).
Future<int> queryConteudoHomeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ConteudoHomeRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ConteudoHomeRecord>> queryConteudoHomeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ConteudoHomeRecord.collection,
      ConteudoHomeRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ConteudoHomeRecord>> queryConteudoHomeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
